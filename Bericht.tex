...
\usepackage[backend=biber, sorting=nyt,natbib=true]{biblatex} % Ähnlich Harvard-Citation style mit \autocite (übernommen aus "Hinweise zum Praktikumsbericht")
...
\input{Kapitel/2_Mode_0}
\input{Kapitel/3_Mode_1}
\input{Kapitel/4_Mode_2}
